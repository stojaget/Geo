<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="KlijentiCRUD.aspx.cs" Inherits="Geodezija.KlijentiCRUD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
        ...
        <Fields>
            ...
            <asp:BoundField DataField="tekuci" HeaderText="tekuci" 
            ...
            <asp:BoundField DataField="dat_kreiranja" HeaderText="dat_kreiranja" InsertVisible="False" ReadOnly="True" DataFormatString="{0:d}"
                SortExpression="dat_kreiranja" />
            <asp:BoundField DataField="dat_azu" HeaderText="dat_azu" InsertVisible="False" ReadOnly="True" DataFormatString="{0:d}"
    ...
    <asp:GridView ID="gvKlijentProj" 
        ...
        <Columns>
            ...
            <asp:BoundField DataField="sifra" HeaderText="Šifra" ReadOnly="True" 
                SortExpression="sifra" InsertVisible="False" />
