<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Aktivnosti.aspx.cs" Inherits="Geodezija.Aktivnosti" %>
...
<asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
    ...
    <Columns>
        ...
        <asp:BoundField DataField="pocetak" HeaderText="pocetak" DataFormatString="{0:d}"
            SortExpression="pocetak" />
        <asp:BoundField DataField="kraj" HeaderText="kraj" SortExpression="kraj" DataFormatString="{0:d}" />
...
<asp:DetailsView ID="DetailsView1" runat="server" AllowPaging="True" 
    ...
    <Fields>
        ...
        <asp:TemplateField HeaderText="pocetak" SortExpression="pocetak" >
            <ItemTemplate>
