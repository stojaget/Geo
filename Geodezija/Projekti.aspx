<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="Projekti.aspx.cs" Inherits="Geodezija.Projekti" %>
    ...
    <div id="projectreport">
      ...
      <asp:BoundField DataField="dat_zavrs" DataFormatString="{0:d}" HeaderText="Dat.završetka" 
            SortExpression="dat_zavrs" />--%>
                        ...
                        <asp:TemplateField HeaderText="Ugov. iznos" SortExpression="ugov_iznos">
                            <HeaderTemplate>
                     ...
                     <HeaderTemplate>
                        ...
                        <%--<asp:BoundField DataField="lova" HeaderText="Lova" SortExpression="lova" DataFormatString="{0:C2}"
                            HtmlEncode="False" />--%>
                        <asp:TemplateField HeaderText="Lova" SortExpression="lova">
                            <HeaderTemplate>
