<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="FileGrid.ascx.cs" Inherits="Geodezija.FileManager.FileGrid" %>
<p>
    <asp:Label ID="lblCurrentPath" runat="server"></asp:Label>
</p>

<asp:GridView ID="gvFiles" runat="server" AutoGenerateColumns="False" 
    CellPadding="4" ForeColor="#333333" GridLines="None" Height="50%" Width="80%" 
    onpageindexchanging="gvFiles_PageIndexChanging" CssClass="CustomView" 
