...
CodeBehind="ProjektiCRUD.aspx.cs" Inherits="Geodezija.ProjektiCRUD" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table class="ui-accordion">
        ...
        <tr>
            <td class="style1">
                <asp:Button ID="Button1" runat="server" CssClass="botuni" 
                    onclick="Button1_Click" Text="Uplatnica" Width="87px" />
            &nbsp;</td>
            <td>
...
<p>
        <asp:TextBox ID="textBox1" runat="server" TextMode="MultiLine" Width="560px" 
