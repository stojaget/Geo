...
namespace Geodezija
{
    ...
    public class Predmet
    {
        ...
        public string Dat_predaja { get; set; }
        public string Dat_potvrde { get; set; }
        public string Dat_zavrs { get; set; }
        public string Dat_kreiranje { get; set; }
        public string Dat_izd { get; set; }
        public string Dat_azuriranja { get; set; }
        //datum predaje
        public string Dat_isp { get; set; }

        public string Dat_placanja { get; set; }
        public string Dat_predajedgu { get; set; }
       ...
       // public bool Ponuda_ind { get; set; }
        ...
        public Predmet()
        {
            ...
            this.Dat_predajedgu = DateTime.Now.ToShortDateString();
