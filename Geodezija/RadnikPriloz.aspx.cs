...
namespace Geodezija
{
    public partial class RadnikPriloz : System.Web.UI.Page
    {
        ...
        protected void btnInsert_Click(object sender, EventArgs e)
        {
            ...
            if (UploadTest.PostedFile != null && UploadTest.PostedFile.ContentLength > 0)
            {
                ...
                int rbr = Convert.ToInt32(Helper.MaxRadnik(sifra)) + 1;

                string fileName = Path.GetFileName(UploadTest.PostedFile.FileName);
                string folder = Server.MapPath("~/Dokumenti/Radnici/" + sifra + @"/" + rbr);
                string putanja = Server.MapPath("~/Dokumenti/Radnici/" + sifra + @"/" + rbr + @"/" + UploadTest.FileName);
                ...
                bool zaht = Helper.UnesiRadnikPrilog(sifra, rbr, UploadTest.FileName, putanja, contentType, DateTime.Now);
