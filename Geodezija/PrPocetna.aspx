<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
 CodeBehind="PrPocetna.aspx.cs" Inherits="Geodezija.PrPocetna" %>
    ...
    <div id="DataDiv" style="overflow: auto; border: 1px solid olive; width: 98%; height: 700px;" onscroll="Onscrollfnction();">
        <asp:GridView ID="gvProjekti" runat="server" AutoGenerateColumns="False" 
            ...
            AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None" 
                 Height="94%" Width= "98%" onselectedindexchanged="gvProjekti_SelectedIndexChanged" 
                onrowdatabound="gvProjekti_RowDataBound" CssClass="CustomView" 
                ShowHeaderWhenEmpty="True">
            <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
            <Columns>
                <asp:BoundField DataField="sifra" HeaderText="ID" Visible="false"
                ...
                <asp:BoundField DataField="dat_kreiranje" HeaderText="Dat.ugov." ConvertEmptyStringToNull="True"
   ...
   <br />
    ...
    <p>
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            SelectCommand="SELECT statusi.naziv, vrsta_posla.naziv AS vrsta_posla, Klijent.naziv AS klijent, Projekt.sifra, Projekt.naziv AS naziv, Projekt.dat_kreiranje, Projekt.ugov_iznos, Projekt.arh_broj, Projekt.dat_predaja, Projekt.placeno, Projekt.dat_potvrde FROM Projekt INNER JOIN statusi ON Projekt.statusID = statusi.sifra INNER JOIN vrsta_posla ON Projekt.vrstaID = vrsta_posla.sifra INNER JOIN Klijent ON Projekt.klijentID = Klijent.sifra" 
        ...
        PREGLED MOJIH AKTIVNOSTI</p>
            <div id="scroll">
                <asp:GridView ID="GridView1" runat="server" CssClass="CustomView" GridLines="None" 
                    DataSourceID="sdsAkt" Height="224px" PageSize="6" ShowHeaderWhenEmpty="True" 
