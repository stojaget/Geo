...
function Datepicker() {
	...
	this.regional[""] = { // Default regional settings
	    monthNames: ['Sijeèanj', 'Veljaèa', 'Ožujak', 'Travanj', 'Svibanj', 'Lipanj',
		'Srpanj', 'Kolovoz', 'Rujan', 'Listopad', 'Studeni', 'Prosinac'],
	    monthNamesShort: ['Sij', 'Velj', 'Ožu', 'Tra', 'Svi', 'Lip',
		'Srp', 'Kol', 'Ruj', 'Lis', 'Stu', 'Pro'],
	    dayNames: ['Nedjelja', 'Ponedjeljak', 'Utorak', 'Srijeda', 'Èetvrtak', 'Petak', 'Subota'],
	    dayNamesShort: ['Ned', 'Pon', 'Uto', 'Sri', 'Èet', 'Pet', 'Sub'],
	    dayNamesMin: ['Ne', 'Po', 'Ut', 'Sr', 'Èe', 'Pe', 'Su'],
	    dateFormat: 'dd.mm.yyyy.', firstDay: 1,
	    renderer: $.datepick.defaultRenderer,
	    prevText: '&#x3c;', prevStatus: 'Prikaži prethodni mjesec',
	    prevJumpText: '&#x3c;&#x3c;', prevJumpStatus: '',
	    nextText: '&#x3e;', nextStatus: 'Prikaži slijedeæi mjesec',
